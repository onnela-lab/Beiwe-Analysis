plot_data_quality = function(stream, frequency, burst_duration, break_duration){
  ...
  plot(log10(.1+bursts[,"avg_within_burst_frequency"]), col=NA,xlab="Unique Daily Measurements",xlim=c(1,nrow(bursts)*1.3),
  ...
  plot(log10(.1+bursts[,"avg_within_burst_duration"]), col=NA,xlab="Unique Daily Measurements",xlim=c(1,nrow(bursts)*1.3),
  ...
  plot(log10(1+bursts[,"avg_between_burst_duration"]-bursts[,"avg_within_burst_duration"]), col=NA,xlab="Unique Daily Measurements",xlim=c(1,nrow(bursts)*1.3),
